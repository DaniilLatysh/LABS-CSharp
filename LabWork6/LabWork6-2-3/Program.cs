...
namespace LabWork6_2_3
{
    ...
    class Program
    {
        ...
        public static void sortStud(Queue<Student> all) {     // sort by exam
        ...
        public static void sortByGoodStud(Queue<Student> all)
        {                                                                   // sort by good stud
            foreach (Student s in all)
            {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                while (!read.EndOfStream)
                {
                    ...
                    all.Enqueue(s);  // add stud to queue
